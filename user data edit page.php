			...
			<div class="center" style="margin: 0 auto; width:495px; border-style: solid; border-color: #f2f2f2;">
				...
				<form class="form-horizontal" action="user data edit tb.php?uid=<?php echo $id?>" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="email" type="text" placeholder="" value="<?php echo $data['e_mail'];?>" required>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input name="mobile" type="text"  placeholder="" value="<?php echo $data['mobile_no'];?>" required>
						</div>
					</div>
